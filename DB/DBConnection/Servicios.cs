...
namespace DB.DBConnection
{
    public class Servicios
    {
        ...
        public DataSet SP_Obtener_IdPermisoColaborador()
        {
            DataSet ds = new DataSet();
            using (SqlConnection connection = new SqlConnection(db.Database.Connection.ConnectionString))
            {
                using (SqlCommand sqlCommand = new SqlCommand("SP_Obtener_IdPermisoColaborador", connection))
                {
                    sqlCommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet Obtener_Id_Detalle_Liquidacion()
        {
            DataSet ds = new DataSet();
            using (SqlConnection connection = new SqlConnection(db.Database.Connection.ConnectionString))
            {
                using (SqlCommand sqlCommand = new SqlCommand("SP_Obtener_IdLiquidacion", connection))
                {
                    sqlCommand.CommandType = CommandType.StoredProcedure;
