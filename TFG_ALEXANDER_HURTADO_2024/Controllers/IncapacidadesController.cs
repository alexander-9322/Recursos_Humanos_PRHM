    ...
    public class IncapacidadesController : Controller
    {
        ...
        public ActionResult Create(incapacidade iNCAPACIDADE)
        {
            try
            {
                ...
                {
                    empleado empleado = db.empleados.FirstOrDefault(d => d.Id_Empleado == iNCAPACIDADE.Empleados_Id_Empleado);
                    catalogo_tipo_incapacidades tipo_incapacidad = db.catalogo_tipo_incapacidades.FirstOrDefault(d => d.idCatalogo_Tipo_Incapacidades == iNCAPACIDADE.IdTipoIncapacidad);
                    TimeSpan diferencia = iNCAPACIDADE.Fecha_Fin - iNCAPACIDADE.Fecha_Inicio;

                    int totalDias = (int)diferencia.TotalDays + 1;

                    decimal porcentaje = 0;


                    // Calcular la diferencia
                    iNCAPACIDADE.Monto_Incapacidad = (empleado.Salario * 8) * totalDias;

                    porcentaje = (decimal)(iNCAPACIDADE.Monto_Incapacidad * tipo_incapacidad.Porcentaje);
                    iNCAPACIDADE.Monto_Incapacidad = iNCAPACIDADE.Monto_Incapacidad - porcentaje;

                    incapacidade incapacidad = db.incapacidades.FirstOrDefault(l => l.Empleados_Id_Empleado == iNCAPACIDADE.Empleados_Id_Empleado);
                    ...
                    {
                        bool estaEntreFechas = (incapacidad.Fecha_Inicio >= iNCAPACIDADE.Fecha_Inicio && incapacidad.Fecha_Inicio <= iNCAPACIDADE.Fecha_Fin)
                        || (incapacidad.Fecha_Fin >= iNCAPACIDADE.Fecha_Inicio && incapacidad.Fecha_Fin <= iNCAPACIDADE.Fecha_Fin);
                        ...
                        {
                            Session["Error"] = "El usuario ya cuenta con una incapacidad en esas fechas";
                        }
                    }
