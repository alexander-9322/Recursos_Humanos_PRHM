    ...
    public class PlanillaController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            foreach (var planilla in planillas)
            {
                ...
                TimeSpan diferencia = DateTime.Now - viewModel.PLANILLA.Fecha;
        ...
        public ActionResult Create(Planilla _objplanilla)
        {
            try
            {
                ...
                if (_objplanilla.PERSONA.Cedula != 0 && _objplanilla.PLANILLA.Horas_Laboradas != 0 && _objplanilla.PLANILLA.Catalago_Deducciones_idCatalago_Deducciones != 0)
                {
        ...
        public ActionResult RecalcularPlanillas()
        {
            try
            {
                var empleados = db.empleados.ToList();
                ...
                foreach (var empleado in empleados)
                {
                    ...
                    var planillas = db.planillas.ToList();

                    foreach (var _planilla in planillas)
                    {
                        planilla.PERSONA.Cedula = persona.Cedula;
                        planilla.PLANILLA.Horas_Laboradas = 48;
                        planilla.PLANILLA.Catalago_Deducciones_idCatalago_Deducciones = 1;
                        planilla.PLANILLA.Id_Planilla = _planilla.Id_Planilla;
