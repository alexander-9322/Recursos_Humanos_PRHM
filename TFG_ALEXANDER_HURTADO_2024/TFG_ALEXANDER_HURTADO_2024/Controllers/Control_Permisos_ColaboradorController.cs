    ...
    public class Control_Permisos_ColaboradorController : Controller
    {
        ...
        public ActionResult Create(control_de_permiso_colaborador cONTROL_DE_PERMISO_COLABORADOR)
        {
            try
            {
                ...
                ViewBag.IdTipoPermiso = new SelectList(db.control_de_permiso_colaborador, "IdCatalogo_Control_permisos_Colaborador", "Descripcion", cONTROL_DE_PERMISO_COLABORADOR.IdTipoPermiso);
                ViewBag.Empleados_Id_Empleado = new SelectList(db.empleados.Include(e => e.persona).ToList(), "Id_Empleado", "persona.Nombre", cONTROL_DE_PERMISO_COLABORADOR.empleado.Id_Empleado);
                return View(cONTROL_DE_PERMISO_COLABORADOR);
            }
            catch (Exception)
            {
